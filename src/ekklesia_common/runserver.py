...
parser.add_argument("-b", "--bind", default="localhost", help="hostname / IP to bind to, default ekklesia-common-localhost")
...
def stackdump_setup():
    ...
    if ultratb is None:
        ...
        logg.info("IPython installed, write stack dumps to tmpdir with: `kill -QUIT <ekklesia_common_pid>`")
...
def run():
    ...
    extra_reload_files = glob.glob('src/ekklesia_common/translations/**/*.mo', recursive=True)
